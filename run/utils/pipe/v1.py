...
class StableDiffusionV1:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        height: Optional[int] = kwargs.pop("height", None)
        width: Optional[int] = kwargs.pop("width", None)
        timesteps: List[int] = kwargs.pop("timesteps", None)
        sigmas: List[float] = kwargs.pop("sigmas", None)
        ...
        cross_attention_kwargs: Optional[Dict[str, Any]] = kwargs.pop(
            "cross_attention_kwargs", None
        )
        guidance_rescale: float = kwargs.pop("guidance_rescale", 0.0)
        clip_skip: Optional[int] = kwargs.pop("clip_skip", None)
        ...
        if exit_step is None:
            exit_step = num_inference_steps
        timesteps = timesteps[start_step:exit_step]
